...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = com.travelsky.airportapp.R.color.general_text_color;
    private static final float DEFAULT_CONNECTING_LINE_WEIGHT_PX = 4;
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = com.edmodo.rangebar.R.drawable.seek_thumb_normal;
    ...
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.BLUE;
    ...
    {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.edmodo.rangebar.R.styleable.RangeBar, 0, 0);

        try {

            // Sets the values of the user-defined attributes based on the XML
            // attributes.
            final Integer tickCount = ta.getInteger(com.edmodo.rangebar.R.styleable.RangeBar_tickCount, DEFAULT_TICK_COUNT);
            ...
            mTickHeightDP = ta.getDimension(com.edmodo.rangebar.R.styleable.RangeBar_tickHeight, DEFAULT_TICK_HEIGHT_DP);
            mBarWeight = ta.getDimension(com.edmodo.rangebar.R.styleable.RangeBar_barWeight, DEFAULT_BAR_WEIGHT_PX);
            mBarColor = ta.getColor(com.edmodo.rangebar.R.styleable.RangeBar_barColor, DEFAULT_BAR_COLOR);
            mConnectingLineWeight = ta.getDimension(com.edmodo.rangebar.R.styleable.RangeBar_connectingLineWeight,
                                                    DEFAULT_CONNECTING_LINE_WEIGHT_PX);
            mConnectingLineColor = ta.getColor(com.edmodo.rangebar.R.styleable.RangeBar_connectingLineColor,
                                               DEFAULT_CONNECTING_LINE_COLOR);
            mThumbRadiusDP = ta.getDimension(com.edmodo.rangebar.R.styleable.RangeBar_thumbRadius, DEFAULT_THUMB_RADIUS_DP);
            mThumbImageNormal = ta.getResourceId(com.edmodo.rangebar.R.styleable.RangeBar_thumbImageNormal,
                                                 DEFAULT_THUMB_IMAGE_NORMAL);
            mThumbImagePressed = ta.getResourceId(com.edmodo.rangebar.R.styleable.RangeBar_thumbImagePressed,
                                                  DEFAULT_THUMB_IMAGE_PRESSED);
            mThumbColorNormal = ta.getColor(com.edmodo.rangebar.R.styleable.RangeBar_thumbColorNormal, DEFAULT_THUMB_COLOR_NORMAL);
            mThumbColorPressed = ta.getColor(com.edmodo.rangebar.R.styleable.RangeBar_thumbColorPressed,
