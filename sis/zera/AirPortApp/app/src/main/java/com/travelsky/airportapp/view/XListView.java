...
public class XListView extends ListView implements OnScrollListener {
	...
	private int SCROLLBACK_HEADER = 0;
	private int SCROLLBACK_FOOTER = 1;
	...
	public void setHeaderShowTxt(String normal,String ready) {
	    mHeaderView.setShowTxt(normal, ready);
	}
	
	public void setFootShowTxt(String normal,String ready) {
	    mFooterView.setShowTxt(normal, ready);
    }
