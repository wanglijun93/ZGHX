 ...
 *         特车页面数据适配器
 */
public class SpecialCarAdapter1 extends BaseAdapter {
    ...
    public SpecialCarAdapter1(Context context, List<FlightData.AccaServiceDateBean> accaServiceBeen, TabLayout mTabLayout, List<String> mTitleList) {
