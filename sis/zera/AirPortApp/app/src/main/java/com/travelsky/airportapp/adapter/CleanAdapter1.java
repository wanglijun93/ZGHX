 ...
 *         清洁也没数据适配器
 */
public class CleanAdapter1 extends BaseAdapter {
    ...
    public CleanAdapter1(Context context, List<FlightData.AccaServiceDateBean> accaServiceBeen, TabLayout mTabLayout, List<String> mTitleList) {
