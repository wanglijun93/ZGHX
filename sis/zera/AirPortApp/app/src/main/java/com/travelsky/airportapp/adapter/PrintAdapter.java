...
public class PrintAdapter extends BaseAdapter {
    ...
    private List<AirInfo.DataBean.AccaServiceBean> accaServiceBean;
    ...
    public PrintAdapter(Context context, List<AirInfo.DataBean.AccaServiceBean> accaServiceBean) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.print_gridview_item, null);
        ...
        //是否签名
        signstate = accaServiceBean.get(position).getSignstate();
        ...
        viewHolder.btn_print_bill.setText(accaServiceBean.get(position).getItem_name());
